...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.grumoon.glauncher.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.grumoon.glauncher.permission.RECEIVE_LAUNCH_BROADCASTS";
